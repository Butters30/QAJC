...
import HomeWork8.ApplicationGlobalState;
...
public class DatabaseRepositorySQLiteImpl implements DatabaseRepository {
    ...
    static {try {Class.forName("org.sqlite.JDBC");}
    ...
    String insertWeatherQuery = "INSERT INTO weather (city, date_time, weather_dayText, " +
            "weather_nightText, minTemperature, maxTemperature) VALUES (?,?,?,?,?,?)";
